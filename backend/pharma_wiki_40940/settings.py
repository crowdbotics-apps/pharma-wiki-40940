"""
Django settings for pharma_wiki_40940 project.
...
ROOT_URLCONF = 'pharma_wiki_40940.urls'
...
WSGI_APPLICATION = 'pharma_wiki_40940.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pharma_wiki_40940 API",
    "DESCRIPTION": "API documentation for pharma_wiki_40940 App",
    "VERSION": "v1",
}
